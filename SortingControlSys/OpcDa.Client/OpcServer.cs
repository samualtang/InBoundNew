...
using OpcRcw.Da;
using OpcDa.Client.Com;

namespace OpcDa.Client
{
    public class OpcServer
    {
        ...
        public void Connect()
        {
            ...
            try
            {
                m_server = OpcDa.Client.Com.Interop.CreateInstance(guid, m_hostName, null);
                m_isConnected = true;
        ...
        public void Disconnect()
        {
            ...
            if (m_server != null)
            {
                OpcDa.Client.Com.Interop.ReleaseServer(m_server);
                m_server = null;
            }
        ...
        public OpcGroup AddGroup(string groupName, int updateRate, bool bActive)
        {
            ...
            try
            {
                ...
                ((IOPCServer)m_server).AddGroup(
                    ...
                    OpcDa.Client.Com.Interop.GetLocale(grp.Locale),
                    out serverHandle,
            ...
            {
                throw OpcDa.Client.Com.Interop.CreateException("IOPCServer.AddGroup", e);
            }
            finally
            {
        ...
        public void RemoveGroup(OpcGroup group)
        {
            ...
            {
                throw OpcDa.Client.Com.Interop.CreateException("IOPCServer.RemoveGroup", e);
            }
