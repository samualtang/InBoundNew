...
{
    public partial class win_yxytrough : Form
    {
        ...
        {
            sign = "0";
            win_trough_handle trough_handle = new win_trough_handle(sign,"","30","");
        ...
        private void btn_amend_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                ...
                sign = "1";
                win_trough_handle trough_handle = new win_trough_handle(sign,amend_id,"30","");
                trough_handle.WindowState = FormWindowState.Normal;
                trough_handle.StartPosition = FormStartPosition.CenterScreen;
                trough_handle.ShowDialog();
                seek();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                try
                {
                    ...
                    amend_id = this.troughdata.SelectedRows[0].Cells[5].Value.ToString();
