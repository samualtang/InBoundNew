...
{
    public partial class w_export_YXY : Form
    {
        ...
        private void seek()
        {
            ...
            String strsql = "SELECT batchcode,sum(t.taskquantity) as qty,COUNT(*)as cuscount,t.synseq,count(distinct regioncode) as regioncodecount from t_un_task t where t.state=15 group BY t.batchcode,t.synseq order by synseq ";
