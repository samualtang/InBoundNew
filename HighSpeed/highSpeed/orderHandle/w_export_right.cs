...
namespace highSpeed.orderHandle
{
    public partial class win_export_right : Form
    {
        ...
        private void seek()
        {
            ...
            String strsql = "SELECT synseq,sum(t.orderquantity) as qty,COUNT(*)as taskcount from highspeed.t_produce_task t where exportnum='R02' group BY t.synseq";
        ...
        private void win_export_right_Load(object sender, EventArgs e)
        {
            orderdata.ClearSelection();
        }
        ...
        private void export(String synseq)
        {
            ...
            String tasknum = "", cuscode = "",palletnum="", cusname = "", itemno = "", itemname = "", quantity = "", address = "", regioncode = "", orderdate = "", companyname = "";
            String sql = "select a.companyname,trunc(plantime)as orderdate,a.tasknum,a.customercode,a.customername," +
                         ...
                         "where a.tasknum=b.tasknum and a.customercode=c.CODE and a.exportnum='R02' and a.synseq='" + synseq + "' order by tasknum";
            Db.Open();
