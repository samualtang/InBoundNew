...
{
    public partial class FmSortMainbelt1 : Form
    {
                ...
                foreach (var item in infolist)
                {
                    if (infolist[i].Count > 0)
                    {
                        ...
                        while (j < infolist[i].Count() && j < 6)
                        {
                            ...
                            if (i == 0)
                            {
                                btn[6 - j - 1].Text = ChangeStr(infolist[i][infolist[i].Count() - 1 - j].CIGARETTENAME);
                                btn[6 - j - 1].Visible = true;
                                j++;  
                            }
                            else
                            {
                                btn[i * 6 + j].Text = ChangeStr(infolist[i][j].CIGARETTENAME);
                                btn[i * 6 + j].Visible = true;
                                j++;
                            }
                        }
                    }
