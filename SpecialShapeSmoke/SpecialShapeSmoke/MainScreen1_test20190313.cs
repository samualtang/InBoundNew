...
{
    public partial class MainScreen1_test20190313 : Form
    {
        ...
        TextBox txtbox3;
        TextBox txtbox4;
        public MainScreen1_test20190313()
        {
            InitializeComponent();
            writeLog.Write("程序打开");
            ...
            try
            {
                ...
                prontcount = Convert.ToInt32(ConfigurationManager.AppSettings["prontcount"].ToString());
            }
            catch (Exception e)
            {
