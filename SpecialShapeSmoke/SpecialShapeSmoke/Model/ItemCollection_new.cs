    ...
    { 
        ...
        public static List<string> GetSortBeltByShapeItem(string plcid)// 混合烟道白皮带
        {
            ...
            switch (plcid)
            {
                ...
                list.Add("S7:[UnnormalConnection1]DB100,DINT130");
                list.Add("S7:[UnnormalConnection1]DB100,DINT134");
                list.Add("S7:[UnnormalConnection1]DB100,DINT138");
                list.Add("S7:[UnnormalConnection1]DB100,DINT142");
                list.Add("S7:[UnnormalConnection1]DB100,DINT146");
                list.Add("S7:[UnnormalConnection1]DB100,DINT150");
                list.Add("S7:[UnnormalConnection1]DB100,DINT154");
                list.Add("S7:[UnnormalConnection1]DB100,DINT158");
